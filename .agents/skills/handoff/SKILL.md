...
- **SKILL SYNC CHECK:** If any skill or rule file was modified this session (`.agents/skills/`, `.agents/AGENTS.md`, `.cursor/skills/`, `.cursor/rules/`) → **WARN the user:** "อย่าลืม mirror การเปลี่ยนแปลงนี้ไปยัง [.cursor/ | .agents/] ด้วย ก่อนปิด session"
...
- [`skill-name`](.agents/skills/) — [one-line reason]
